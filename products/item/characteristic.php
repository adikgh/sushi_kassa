...
<?php include "../../block/header.php"; ?>
	...
	<div class="pitem">
		...
		<!-- <div class="item_c">
			<div class="item_is">Характеристика:</div>
			<div class="item_ib">

				<div class="item_isi">
					<div class="item_isin">Размеры:</div>
					<div class="item_isic">
						<div class="item_isicn">Высота, мм</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
				</div>
				<div class="item_isi">
					<div class="item_isin">Лампы:</div>
					<div class="item_isic">
						<div class="item_isicn">Количество ламп</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Мощность лампы, W</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Общая мощность, W</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Тип цоколя</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Тип лампочки (основной)</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Напряжение, V</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
				...
				<div class="item_isi">
					<div class="item_isin">Цвет и материал:</div>
					<div class="item_isic">
						<div class="item_isicn">Виды материалов</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Материал арматуры</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Материал плафонов</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Цвет арматуры</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Цвет плафонов</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
				...
				<div class="item_isi">
					<div class="item_isin">Дополнительно:</div>
					<div class="item_isic">
						<div class="item_isicn">Степень защиты, IP</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Место установки</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
					<div class="item_isic">
						<div class="item_isicn">Гарантия производителя</div>
						<div class="form_im">
							<input type="text" value="<?=$product_d['name_ru']?>" />
						</div>
					</div>
