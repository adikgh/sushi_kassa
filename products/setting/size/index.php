<?php include "../../../config/acore.php";
	...
	// 
	$size = db::query("select * from product_size order by number asc limit 50");
	$filter = 0;
...
<?php include "../../block/header.php"; ?>
	...
	<div class="">
		...
		<? if (mysqli_num_rows($size) != 0): ?>
			...
			<div class="">
				<div class="">
					<div class="btn"><i class="fal fa-plus"></i><span>Добавить размер</span></div>
				</div>
			</div>
							...
							<div class="uc_uil">
								<div class="uc_uile">
									...
									<a class="uc_uiln" href="#/user/admin/users/item/?id=<?=$buy_d['id']?>">
										<div class="uc_ui_icon lazy_img" data-src="/assets/uploads/products/<?=$buy_d['img']?>"><?=($buy_d['img']!=null?'':'<i class="fal fa-ruler"></i>')?></div>
										<div class="uc_uinu">
